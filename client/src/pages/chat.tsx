    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-teal-50 dark:from-gray-900 dark:via-blue-900 dark:to-teal-900">
      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col">
          {/* Mobile Header */}
          <div className="lg:hidden flex items-center justify-between p-4 border-b border-white/20 bg-white/70 dark:bg-white/10 backdrop-blur-sm shadow-lg">
            ...
            <div className="flex items-center gap-2">
              ...
              <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
                ...
                <SheetContent side="right" className="w-80 bg-white/90 dark:bg-white/10 backdrop-blur-sm border-white/20">
