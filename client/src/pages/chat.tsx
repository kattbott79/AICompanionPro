...
export default function Chat() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 dark:from-gray-900 dark:via-purple-900 dark:to-pink-900 text-gray-900 dark:text-gray-100">
      {/* Main Layout */}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-700/50 cursor-pointer hover:bg-gray-700/50 transition-colors">
                      <img 
                        ...
                        className="w-full h-16 object-cover rounded mb-2" 
                      />
                      <h4 className="font-medium text-indigo-400 text-sm mb-1">Personal Assistant</h4>
                      <p className="text-xs text-gray-400">Daily routines, health tracking, home management</p>
